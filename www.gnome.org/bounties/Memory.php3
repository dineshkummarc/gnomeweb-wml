...
<?php taskrow ("Add image data to the icon cache", "hidden", "Novell", "100", "169344", ""); ?>
<?php taskrow ("Create a test suite for browsing in Nautilus", "hidden", "Novell", "200", "169346", ""); ?>
<?php taskrow ("Remove duplication of desktop backgrounds", "hidden", "Novell", "200", "169347", "http://bugzilla.gnome.org/attachment.cgi?id=38926"); ?>

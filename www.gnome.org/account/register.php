...
if ($submit) {
	...
	*/
	$register=account_register_new(strtolower($unix_name),$realname,$password1,$password2,$email,$language,$timezone,$language_id,$timezone);
	if ($register) {
		echo $HTML->header(array('title'=>'Register Confirmation'));
		?>
		<p>
		<b>Gnome.org : New Account Registration Confirmation</b>
		<p>
		Congratulations. You have registered on Gnome.org.
		<p> 
...
$HTML->header(array('title'=>'Gnome.org : Register'));
...
?>
<p><b>Gnome.org New Account Registration</b>
<?php 
if ($feedback) {
	print "<p><FONT color=#FF0000>$feedback $register_error</FONT>";
} 
?>
<form action="http://<?php echo $HTTP_HOST.$PHP_SELF; ?>" method="post">
<p>
Login Name:<br>
...
It will not be displayed on the site. </I>

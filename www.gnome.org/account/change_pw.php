...
if (register_valid()) {
	...
	?>
	<p><b>Gnome.org Change Confirmation</b>
	<p>
	Congratulations. You have changed your password.
	This change is immediate on the web site.
	<p>You should now <a href="/account/">Return to User Prefs</a>.
	<?php
} else { // not valid registration, or first time to page
	site_user_header(array(title=>"Change Password"));
	?>
	<p><b>Gnome.org Password Change</b>

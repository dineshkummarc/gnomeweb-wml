...
// send mail
$message = "Thank you for registering on the GNOME web site. In order\n"
...
if ($row_user[status] == 'P') {
	mail($row_user[email],"gnome.org Account Registration",$message,"From: admin@$GLOBALS[sys_default_domain]");

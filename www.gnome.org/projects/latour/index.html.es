...
<ul id="general">
      ...
      <li id="siteaction-gnome_development">
        <a title="Development" href="http://developer.gnome.org/">Development</a>
      </li>
      <li id="siteaction-gnome_community">
        <a title="Community" href="http://www.gnome.org/community/">Community</a>
      </li>
    </ul>
<div id="languages"><a href="index.en.html">English</a> &middot; <a href="index.es.html">Español</a> &middot; <a href="index.pt.html">Portugués</a></div>
...
<p>Este año, <a href="http://br.gnome.org">GNOME Brasil</a> y <a
href="http://noticias.gnome.cl/">GNOME Chile</a> serán los anfitriones de las
dos paradas del Tour. Respectivamente Fórum GNOME y Día GNOME.</p>
...
<h3>¡Únete!</h3>
<p>¿Te gustaría que tu ciudad sea una de las anfitrionas el próximo año?<br/>
¿Te gustaría convertirte en colaborador del proyecto?<br/>
¿Te gustaría estar ahí?</p>

<p>¡Entonces dilo! ¡Empieza a contribuir!</p>

<ul>
  <li>Únete a tu lista de correo local: <a
  href="http://mail.gnome.org/mailman/listinfo/gnome-cl-list">Chile</a>, <a
  href="http://mail.gnome.org/mailman/listinfo/gnome-br-list">Brasil</a> o
  dinos que <a
  href="http://mail.gnome.org/mailman/listinfo/gugmasters-list">quieres crear
  una para tu país</a>.</li>
  <li>Entra a GNOME: <a href="http://live.gnome.org/Bugsquad">ayúdanos a
  clasificar reportes de error</a></li>
  <li>Programa para GNOME: crea nuevas extensiones, <a
  href="http://live.gnome.org/GnomeLove">arregla algunos errores</a></li>
  <li>¡Organiza un evento! Estaremos felices de orientarte e incluso enviar
  ponentes, solo dinos lo que estás pensando.</li>
</ul>

<p>Y por supuesto, <a
href="http://mail.gnome.org/mailman/listinfo/gugmasters-list">escríbenos</a>
diciendo que el próximo año quieres ser parte del Tour para considerarte como un
candidato.
</p>
</div>
<div id="latour-logo">
...
<img src="latour-logo.png"/>
  ...
  está ahí, con un día completo para sí. Los geniales chicos de GNOME Chile
  están a cargo, <a
  ...
  sobre su escritorio favorito. Ésta vez, Latinoware (una de las más grandes
  conferencias de América Latina) será anfitrión del Fórum GNOME. <a
  href="http://mail.gnome.org/mailman/listinfo/gnome-br-list">Contacta a GNOME
  Brasil</a> para estar ahí.<br/>
  <br/><a href="http://br.gnome.org/GNOMEBR/VForum">Fórum GNOME</a> &middot; <a href="http://latinoware.org">Latinoware</a>
  </p>
</div>
</div>
<div id="footer">

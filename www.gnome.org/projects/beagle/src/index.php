...
<p>
The most recent version of Beagle is <b>0.0.6.1</b>, which
was released on February 16, 2005.  You can
<a href="http://ftp.gnome.org/pub/GNOME/sources/beagle/0.0/beagle-0.0.6.1.tar.gz">
download the 0.0.6.1 tarball here</a>.
</p>
...
<h2 id="see">See Beagle Run</h2>

<img src="img/video.png" class="img-leader">
<p>
<a href="http://nat.org">Nat Friedman</a> has made
<a href="http://nat.org/demos">a series of short movies</a>
that show Beagle in action.  (Flash player required.)
</p>
...
<a href="http://www.dotlucene.net">DotLucene</a>,
...
<p>
Beagle is still in an early stage of development, and contributions

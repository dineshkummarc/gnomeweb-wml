...
function html_build_select_box_from_arrays ($vals,$texts,$select_name,$checked_val='xzxzxzx',$show_100=true,$text_100='None') {
	/*
...
function site_user_header($params) {
	...
	*/
	...
	echo '
	<P>
	<A HREF="/my/">My Personal Page</A> | <A HREF="/account/">Account Options</A>
	| <A HREF="/register/">Register a Project</A>
	<P>';

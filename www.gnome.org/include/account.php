...
*/
function account_register_new($unix_name,$realname,$password1,$password2,$email,$language,$timezone,$language_id,$timezone) {
	global $feedback;
	...
	$result=db_query("INSERT INTO users (user_name,user_pw,realname,email,"
		. "status,confirm_hash,language,timezone) "
		. "VALUES ('$unix_name',".
		"'". md5($password1) . "',".
		"'". "$realname',".
		"'$email',".
	...
	if (!$result || !$user_id) {
		...
		// send mail
		$message = "Thank you for registering on the Gnome.org web site. In order\n"

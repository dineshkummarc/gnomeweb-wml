...
<table cellpadding=5 cols=3 width="700" text="#ffffff" align=center>
<tr bgcolor="#000000" align=center>
    ...
    <td width="16%"><font color="#ffffff">Room 33-422</font></td>
...
<tr bgcolor="#c8d4e2">
    ...
    <td>Registration & coffee</td> <!-- 33-419 -->
    <td bgcolor="#ffffff" colspan=4></td> <!-- 33-418 -->
<tr bgcolor="#c8d4e2">
    <td bgcolor="#acaba9" align=right>10:00 AM</td>
    <td>Opening address, Nat Friedman</td> <!-- 33-419 -->
    <td colspan=4 bgcolor="#ffffff"></td> <!-- 33-418 -->
<tr bgcolor="#c8d4e2">
...
<tr bgcolor="#c8d4e2">
    ...
    <td></td> <!-- 33-422 -->
    <td rowspan=2>&quot;GNOME Project Infrastructure,&quot; Jeff Waugh.</td> <!--  1-135 -->
    <td></td> <!--  1-136 -->
<tr bgcolor="#c8d4e2">
...
<tr bgcolor="#c8d4e2">
    <td bgcolor="#acaba9" align=right>5:00 PM</td>
    <td>Closing address, Havoc Pennington.</td> <!-- 33-419 -->
    <td colspan=4 bgcolor="#ffffff"></td> <!-- 33-418 -->
</table>
    	</td></tr>
        </table>

...
/*	
	...
	if (!$form_homepage) {
		$form_homepage='http://www.gnome.org';
	}
*/
	$result=db_query('UPDATE groups SET '
		."group_name='$form_group_name',"
		."url_homepage='$form_homepage',"
		."url_download='$form_download',"
		."url_cvs='$form_cvs',"
		."url_mail='$form_mail',"
...
<P>Download Link (fully qualify):
<BR><font color="#FFFFFF">http://</font><INPUT type="text" size="60" maxlength="255" name="form_download" value="'.$row_grp['url_download'].'"></P>

<P>Mailing List Link:
<BR>http://<INPUT type="text" size="60" maxlength="255" name="form_mail" value="'.$row_grp['url_mail'].'"></P>

<P>Bug Tracker Link: <BR>http://<INPUT type="text" size="60" maxlength="255" name="form_bugtracker" value="'.$row_grp['url_bugtracker'].'"></P>

<P>CVS Link:
<BR>http://<INPUT type="text" size="60" maxlength="255" name="form_cvs" value="'.$row_grp['url_cvs'].'"></P>

<P>Screenshot Link:
<BR>http://<INPUT type="text" size="60" maxlength="255" name="form_screenshot" value="'.$row_grp['url_screenshot'].'"></P>

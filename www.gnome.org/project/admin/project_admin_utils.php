...
function project_admin_header($params) {
	...
	<A HREF="/project/admin/?group_id='.$group_id.'">Admin</A> | ';
        if ($is_admin)
	echo '<A HREF="/project/admin/userperms.php?group_id='.$group_id.'">Member Permissions</A> | 
	<A HREF="/project/admin/editgroupinfo.php?group_id='.$group_id.'">General Info</A> |
	<A HREF="/project/admin/history.php?group_id='.$group_id.'">Project History</A>
        <br>';
	echo '
	<A HREF="/project/admin/group_trove.php?group_id='.$group_id.'">Software Map</A> |
	<A HREF="/project/admin/newrelease.php?group_id='.$group_id.'">New Release</A> |
	<A HREF="/project/admin/editreleases.php?group_id='.$group_id.'">Edit Releases</A>';
        /*if ($is_admin)
			// Commented out for now. hopefully we will implement this later to 
